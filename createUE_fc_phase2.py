...
def main():
    ...
    phase2prep_DTcalc_for_ph2_ph3.phase2_prep('/various/mtzortzi/from_nikela/phase1_labeled.csv')
    print('DONE')

    print('........DT_calculation for phase2........')
    # it creates the phase2.csv 
    phase2prep_DTcalc_for_ph2_ph3.DT_calculation('/various/mtzortzi/from_nikela/phase1_nodewise_UE_fc.csv')
    print('DONE')    
